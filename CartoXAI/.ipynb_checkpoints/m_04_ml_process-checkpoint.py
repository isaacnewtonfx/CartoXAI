...
def assess_obs_vs_pred(model, obs, relevant_features, target, out_plot_file=None):
    """
    A function to assess the correlation between the observed and predicted values. Uses pearson correlation
    ...
    plt.text(3, 4, "corr.: " + str(corr), horizontalalignment='left', size='medium', color='black', weight='semibold')
