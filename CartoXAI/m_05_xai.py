...
def calc_local_interpretability(explainer, X_dataset):
    ...
    if type(explainer) is fasttreeshap.explainers._tree.Tree:
        ...
        # Faster algorithm
        shap_values_npy = explainer(X_dataset, check_additivity=False).values
        
    else:
        
        # Slower algorithm
        shap_values_npy = explainer.shap_values(X_dataset, check_additivity=False)
    ...
    # calc proportional shares as percentages
